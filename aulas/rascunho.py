...
entrada = tkinter.Entry(mainframe, width=10, takefocus=1, bg="white", font=("Helvetica", 16, "bold"))
entrada.pack(pady=10)

btn = tkinter.Button(mainframe, text="CALCULAR", command=par_check, width=10, takefocus=1)
btn.pack(pady=5)
